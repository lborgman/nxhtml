...
;; Test
(ertn-should (eq (default-value 'word-wrap3) nil))
(ertn-should (eq word-wrap3 t))
(ertn-should (eq (default-value 'word-wrap2) nil))
(ertn-should (eq word-wrap2 t))
(ertn-should (eq (default-value 'truncate-lines) nil))
(ertn-should (eq truncate-lines t))
(ertn-should (eq (default-value 'word-wrap) nil))
(ertn-should (eq word-wrap t))
